  ...
  return (
    ...
    <div className="slider mt-4">
      <div className="slide-track">
        <div className="slide">
          <img src={process.env.PUBLIC_URL + "/imagenes/imagenes-marcasgrilla/marcas_adata.jpg"}  height="100" width="250" alt="adata"/>
        </div>
        <div className="slide">
          <img src={process.env.PUBLIC_URL + "/imagenes/imagenes-marcasgrilla/marcas_amd.jpg"} height="100" width="250" alt=""/>
        </div>
        <div className="slide">
          <img src={process.env.PUBLIC_URL + "/imagenes/imagenes-marcasgrilla/marcas_asrock.jpg"} height="100" width="250" alt=""/>
        </div>
        <div className="slide">
          <img src={process.env.PUBLIC_URL + "/imagenes/imagenes-marcasgrilla/marcas_asus.jpg"} height="100" width="250" alt=""/>
        </div>
        <div className="slide">
          <img src={process.env.PUBLIC_URL + "/imagenes/imagenes-marcasgrilla/marcas_azza.jpg"}  height="100" width="250" alt=""/>
        </div>
        <div className="slide">
